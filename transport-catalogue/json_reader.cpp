...
void LoadJson::GetRenderRoute(svg::Document& route_render) {
    size_t count = 0;
...
void LoadJson::GetRenderNameRoute(svg::Document& route_render) {
...
void LoadJson::GetRenderSimStop(svg::Document& route_render) {
...
std::string LoadJson::PrintRender() {
    ...
    GetRenderRoute(route_render);
    GetRenderNameRoute(route_render);
    GetRenderSimStop(route_render);
